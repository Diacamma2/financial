...
class BillTest(InvoiceTest):
    ...
    def test_with_categorybill_check_numbering(self):
        ...
        self.assert_observer('core.custom', 'diacamma.invoice', 'billShow')
        self.assertEqual(len(self.json_actions), 6)
        self.assertEqual(self.json_actions[0]['id'], 'diacamma.invoice/billTransition')
        self.assertEqual(self.json_actions[1]['id'], 'diacamma.invoice/billTransitionArchive')
        self.assertEqual(self.json_actions[2]['id'], 'diacamma.invoice/billPrint')
        self.assertEqual(self.json_actions[3]['id'], 'diacamma.invoice/billToBill')
        ...
        self.assertEqual(self.json_actions[1]['id'], 'diacamma.invoice/billTransitionArchive')
        self.assertEqual(self.json_actions[2]['id'], 'diacamma.invoice/billPrint')
        self.assertEqual(self.json_actions[3]['id'], 'diacamma.invoice/billToOrder')
        self.assertEqual(self.json_actions[4]['id'], '')
