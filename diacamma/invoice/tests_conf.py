...
class ConfigTest(LucteriosTest):
    ...
    def test_catogoriesbill(self):
        ...
        self.assert_select_equal('printmodel', {0: None, 8: 'facture', 9: 'règlement', 15: 'facture avec TVA'})
        self.assert_json_equal('SELECT', 'printmodel_sold', 0)
        self.assert_select_equal('printmodel_sold', {0: None, 8: 'facture', 9: 'règlement', 15: 'facture avec TVA'})
